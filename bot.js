...
I the get session message and caption,  add csnt get code? As a button under it

When sure click it, the bot ask for user number in this full format +2349163....must be up to 13 digits, when user send it, the bot forwards the number to admin, and wait for admin to send pairing-code shixh is 8 words, when admin sens rhe code, it then forwards the code to the user with this format 

Your pairing code is [then add the code sent by ssmin]
