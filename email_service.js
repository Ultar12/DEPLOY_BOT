...
async function sendPaymentConfirmation(toEmail, userName, referenceId, appName, botType, sessionId) {
  ...
  const mailOptions = {
    ...
    to: toEmail,
    subject: 'Your ULTAR Bot Deployment is Confirmed!',
    html: `
      <div style="background-color: #121212; padding: 20px; font-family: sans-serif; color: #fff; text-align: center; border-radius: 10px;">
        ...
        <p style="font-size: 16px;">You will receive a notification in our Telegram bot as soon as your bot, <strong>${escapedAppName}</strong>, is fully online and ready to go.</p>
        ...
        <p style="font-size: 12px; color: #aaa; margin-top: 20px;">If you require any assistance, our support team is always here to help.</p>
        <p style="font-size: 14px; margin-top: 20px;">Sincerely,<br><strong>ULTAR'S WBD Team</strong></p>
      </div>
    `,
  };
